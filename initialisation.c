...
void initBouton(ECE_City * eceCity){
    ...
    eceCity->image.bouton_capi.x1 = 185;
    eceCity->image.bouton_capi.y1 = 250;
    eceCity->image.bouton_capi.x2 = 855;
    eceCity->image.bouton_capi.y2 = 932;
    eceCity->image.bouton_commu.x1 = 1045;
    eceCity->image.bouton_commu.y1 = 250;
    eceCity->image.bouton_commu.x2 = 1715;
...
void loadImages(ECE_City * eceCity){
    ...
    eceCity->image.image_fond_nuit = LoadTexture("../Images/FOND_NUIT.png");
